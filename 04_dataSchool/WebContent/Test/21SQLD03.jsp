...
<body class="w3-content" style="max-width: 1200px">
	...
	<div class="w3-main" style="margin-left: 250px">
		...
		<a class="next" href="${pageContext.request.contextPath}/data?command=test&value=21&value2=04&value3=4" >
	...
	<script>
		...
		function serve() {
		  ...
		  var data = "command=exam&id=" + id + "&testIdenty=21SQLD&testNum=3&inputAnswer=" + answer_value;
