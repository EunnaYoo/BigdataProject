...
<body class="w3-content" style="max-width: 1200px">
	...
	<div class="w3-main" style="margin-left: 250px">
		...
		<h4 class="content_title top">☞ 응시자격 : 제한없음</h4>
		<h4 class="content_title top">☞ 합격기준</h4>
		<table class="data top" cellpadding="0" cellspacing="0" summary="합격기준" border="1" style="margin-left: 10px; text-align: center;">
			<colgroup>
				<col width="50%" />
				<col width="50%" />
			</colgroup>
