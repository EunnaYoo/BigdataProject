...
<body class="w3-content" style="max-width: 1200px">
	...
	<div class="w3-main" style="margin-left: 250px">
		...
		<div class="box official">
			<div class="detail">
				<h4 class="content_title top">☞ 관련 근거</h4>
				<P class = "indent">
		...
		<p style="font-weight: bold">SQL 전문가의 정의</p>
		<p class="indent">SQL 전문가(SQLP*, SQL Professional)란 데이터베이스와
			데이터모델링에 대한 지식을 바탕으로 데이터를 조작하고 추출하는데 있어서 정확하고 최적의 성능을 발휘하는 SQL을 작성할 수
			있고, 이를 토대로 SQL을 내포하는 데이터베이스 프로그램이나 응용 소프트웨어의 성능을 최적화하거나, 이러한 성능 최적화를
			지원할 수 있는 데이터베이스 개체(뷰, 인덱스 등)의 설계와 구현 등의 직무를 수행하는 전문가를 말한다.</p>
		<hr>

		<h4 class="content_title">☞ SQL 전문가 자격검정의 필요성</h4>
		...
		<table class="data top" cellpadding="0" cellspacing="0"
			...
			<tbody>
				...
				<tr>
					...
					<td class="last">
						<ul class="list">
							<li>데이터베이스 성능을 결정짓는 가장 핵심적인 요소는 애플리케이션에 집중되어 있다. SQL을 한 번만
								수행해도 같은 결과를 얻을 수 있는데 불필요하게 많은 SQL을 수행하거나, 파싱을 많이 일으키거나, 많은 I/O를
								일으키도록 구현하는 것이 성능 문제를 발생시킨다. 본 직무는 고성능 SQL, 아키텍처 기반의 데이터베이스 튜닝
								원리, Lock과 트랜잭션 동시성 제어 기법, 옵티마이저의 세부적인 작동 원리, 인덱스와 조인 튜닝 원리의 이해를
								통해 SQL을 튜닝하는 작업 등을 수행한다.</li>
						</ul>
					</td>
				</tr>
			</tbody>
